...
- **Priority tie-break** — when two cards earn the same, your hand-set card order decides. During a drag, neighboring rows slide into their preview positions before you drop; the reorder handle also supports the arrow keys.
